    ...
    public class Upload : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadImage(IFormFile file)
        {
            ...
            try
            {
                ...
                var storageClient = await StorageClient.CreateAsync(GoogleCredential.FromFile(@"C:\TEST\DOAN\doantotnghiep\BPMaster\Firebase\mydb-71221-firebase-adminsdk-gbxif-956bae5ad4.json"));
